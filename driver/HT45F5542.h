...
//		Holtek HT45F5542 microcontroller.
//	Generated by HTFileParse.dll.
//	[VERSION] 1.0, 4
// Do not modify manually.

#ifndef _HT45F5542_H_
#define _HT45F5542_H_
...
typedef struct {
	unsigned char __sledc0 : 1;
	unsigned char __sledc1 : 1;
	unsigned char __sledc2 : 1;
	unsigned char __sledc3 : 1;
	unsigned char __sledc4 : 1;
	unsigned char __sledc5 : 1;
	unsigned char __sledc6 : 1;
	unsigned char __sledc7 : 1;
} __sledc_bits;
...
typedef struct {
	unsigned char __ptvlf : 1;
	unsigned char __pttclr0 : 1;
	unsigned char __pttclr1 : 1;
	unsigned char : 5;
} __ptmc2_bits;
...
DEFINE_SFR(__vbgrc_type, __vbgrc, 0x0b);
...
DEFINE_SFR(__sledc_type, __sledc, 0x1b);
DEFINE_SFR(__pscr_type, __pscr, 0x1d);
DEFINE_SFR(__lvdc_type, __lvdc, 0x1e);
DEFINE_SFR(__sdsw_type, __sdsw, 0x20);
DEFINE_SFR(__sdpgac0_type, __sdpgac0, 0x21);
DEFINE_SFR(__sdpgac1_type, __sdpgac1, 0x22);
DEFINE_SFR(__sda0c_type, __sda0c, 0x23);
DEFINE_SFR(__sda0vos_type, __sda0vos, 0x24);
DEFINE_SFR(__sda1c_type, __sda1c, 0x25);
DEFINE_SFR(__sda1vos_type, __sda1vos, 0x26);
DEFINE_SFR(__stmc0_type, __stmc0, 0x27);
DEFINE_SFR(__stmc1_type, __stmc1, 0x28);
DEFINE_SFR(__sfr_byte, __stmdl, 0x29);
DEFINE_SFR(__sfr_byte, __stmdh, 0x2a);
DEFINE_SFR(__sfr_byte, __stmal, 0x2b);
DEFINE_SFR(__sfr_byte, __stmah, 0x2c);
DEFINE_SFR(__sfr_byte, __sadol, 0x2d);
DEFINE_SFR(__sfr_byte, __sadoh, 0x2e);
...
DEFINE_SFR(__simc0_type, __simc0, 0x41);
DEFINE_SFR(__simc1_type, __simc1, 0x42);
DEFINE_SFR(__uucr1_type, __uucr1, 0x42);
DEFINE_SFR(__sima_type, __sima, 0x43);
DEFINE_SFR(__simc2_type, __simc2, 0x43);
DEFINE_SFR(__uucr2_type, __uucr2, 0x43);
DEFINE_SFR(__sfr_byte, __simd, 0x44);
DEFINE_SFR(__utxr_rxr_type, __utxr_rxr, 0x44);
DEFINE_SFR(__simtoc_type, __simtoc, 0x45);
DEFINE_SFR(__ubrg_type, __ubrg, 0x45);
DEFINE_SFR(__uusr_type, __uusr, 0x46);
...
DEFINE_SFR(__pas0_type, __pas0, 0x4c);
DEFINE_SFR(__pas1_type, __pas1, 0x4d);
DEFINE_SFR(__pbs0_type, __pbs0, 0x4e);
DEFINE_SFR(__pbs1_type, __pbs1, 0x4f);
DEFINE_SFR(__ifs0_type, __ifs0, 0x50);
DEFINE_SFR(__ptmc0_type, __ptmc0, 0x52);
DEFINE_SFR(__ptmc1_type, __ptmc1, 0x53);
DEFINE_SFR(__ptmc2_type, __ptmc2, 0x54);
DEFINE_SFR(__sfr_byte, __ptmdl, 0x55);
DEFINE_SFR(__sfr_byte, __ptmdh, 0x56);
DEFINE_SFR(__sfr_byte, __ptmal, 0x57);
DEFINE_SFR(__sfr_byte, __ptmah, 0x58);
DEFINE_SFR(__sfr_byte, __ptmbl, 0x59);
DEFINE_SFR(__sfr_byte, __ptmbh, 0x5a);
DEFINE_SFR(__sfr_byte, __ptmrpl, 0x5b);
DEFINE_SFR(__sfr_byte, __ptmrph, 0x5c);
DEFINE_SFR(__isgenc_type, __isgenc, 0x5d);
DEFINE_SFR(__sfr_byte, __isgdata0, 0x5e);
DEFINE_SFR(__sfr_byte, __isgdata1, 0x5f);
...
#define _ptmc2    __ptmc2.byte
#define _ptmdl    __ptmdl
#define _ptmdh    __ptmdh
#define _ptmal    __ptmal
#define _ptmah    __ptmah
#define _ptmbl    __ptmbl
#define _ptmbh    __ptmbh
#define _ptmrpl   __ptmrpl
#define _ptmrph   __ptmrph
...
#define _sledc0   __sledc.bits.__sledc0
#define _sledc1   __sledc.bits.__sledc1
#define _sledc2   __sledc.bits.__sledc2
#define _sledc3   __sledc.bits.__sledc3
#define _sledc4   __sledc.bits.__sledc4
#define _sledc5   __sledc.bits.__sledc5
#define _sledc6   __sledc.bits.__sledc6
#define _sledc7   __sledc.bits.__sledc7
...
#define _sd02     __sdsw.bits.__sd02
...
#define _usime    __intc1.bits.__usime
#define _lve      __intc1.bits.__lve
#define _ade      __intc1.bits.__ade
#define _dee      __intc1.bits.__dee
#define _usimf    __intc1.bits.__usimf
#define _lvf      __intc1.bits.__lvf
#define _adf      __intc1.bits.__adf
#define _def      __intc1.bits.__def
#define _ptmpe    __intc2.bits.__ptmpe
#define _ptmae    __intc2.bits.__ptmae
#define _stmpe    __intc2.bits.__stmpe
#define _stmae    __intc2.bits.__stmae
#define _ptmpf    __intc2.bits.__ptmpf
#define _ptmaf    __intc2.bits.__ptmaf
#define _stmpf    __intc2.bits.__stmpf
#define _stmaf    __intc2.bits.__stmaf
#define _tb0e     __intc3.bits.__tb0e
#define _tb1e     __intc3.bits.__tb1e
#define _pltc1e   __intc3.bits.__pltc1e
#define _tb0f     __intc3.bits.__tb0f
...
#define _ptvlf    __ptmc2.bits.__ptvlf
#define _pttclr0  __ptmc2.bits.__pttclr0
#define _pttclr1  __ptmc2.bits.__pttclr1
